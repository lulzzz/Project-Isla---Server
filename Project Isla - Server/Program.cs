...
namespace Project_Isla___Server
{
    ...
    class Server
    {
        ...
        //Reset event for send callback
        public static ManualResetEvent sendReset = new ManualResetEvent(false);

        //Reset event for disconnect callback
        public static ManualResetEvent disconnectReset = new ManualResetEvent(false);

        //Reset event for accept callback
        public static ManualResetEvent acceptConnectionReset = new ManualResetEvent(false);

        //Reset even for read callback
        public static ManualResetEvent receiveReset = new ManualResetEvent(false);
